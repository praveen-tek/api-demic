...
export const Logo = ({ className, uniColor = true }: { className?: string; uniColor?: boolean }) => {
    return (
        <svg width="32" height="32" viewBox="0 0 182 182" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const LogoInv = ({ className, uniColor }: { className?: string; uniColor?: boolean }) => {
    return (
        <svg width="32" height="32" viewBox="0 0 182 182" fill="none" xmlns="http://www.w3.org/2000/svg">
