        ...
        <section className="bg-background relative overflow-hidden grid min-h-screen grid-rows-[auto_1fr] px-4">
            ...
            <div className="m-auto w-full max-w-sm relative z-10">
                <div className="text-center">
                    <h1 className="geo-regular-italic text-4xl font-medium">Create an account</h1>
                    <p className="text-muted-foreground mt-2 text-sm rethink-sans">Get started with your free account today</p>
                </div>
                <Card
                    variant="outline"
                    className="mt-6 p-8">
