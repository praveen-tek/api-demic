...
DROP TABLE "request_run" CASCADE;--> statement-breakpoint
DROP TABLE "web_socket_preset" CASCADE;--> statement-breakpoint
DROP TABLE "websocket_message" CASCADE;--> statement-breakpoint
DROP TABLE "workspace" CASCADE;--> statement-breakpoint
DROP TABLE "workspace_invite" CASCADE;--> statement-breakpoint
