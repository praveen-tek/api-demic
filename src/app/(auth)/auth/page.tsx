        ...
        <section className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
            <div className="flex flex-col justify-between p-10">
                ...
                <div className="mx-auto w-full max-w-sm">
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground mt-2 text-sm">Your work, your team, your flow all in one place.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <Button
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="size-4 fill-white" viewBox="0 0 256 256">
                ...
                <p className="text-muted-foreground text-xs">
                    <Link href="/legal" className="hover:text-foreground">Help</Link>
                    {' / '}
            ...
            <div className="relative hidden lg:block">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <AniLogo size={260} className="drop-shadow-2xl" />
                </div>
            </div>
        </section>
    )
